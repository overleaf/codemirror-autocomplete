...
import {EditorState, StateEffect, Annotation, EditorSelection, TransactionSpec, Text, ChangeSpec} from "@codemirror/state"
...
export interface Completion {
  ...
  /// Can be used to extend the completion "to" position
